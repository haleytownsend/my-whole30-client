// [ ] Log in
// [ ] Preloaded recipes collection
// [ ] Favorites collection --Add your own notes to the recipes
...
body-parser parses the request bodies. Get access to the information inside the request via req.body.
...
react-modal - create a modal dialog in React.
